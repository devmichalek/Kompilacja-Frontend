...
Jak widać powyższy uchwyt jest błędny. Redukując lewostronnie **nie zawsze** jesteśmy w stanie otrzymać poprawny uchwyt. Pierwszy ```int``` został błędnie zinterpretowany jako **int => T => F**, oczekiwaliśmy redukcji w formie **int => T => F * T**.
